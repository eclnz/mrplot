...
def main():
    ...
    parser.add_argument('--crop', action='store_true',
                      help='Crop images using mask boundaries')
    parser.add_argument('--mask', metavar='PATH', 
                      help='Path to mask NIfTI file for cropping')
    parser.add_argument('--underlay', metavar='PATH',
                      help='Path to underlay NIfTI image')
    parser.add_argument('--mask-underlay', action='store_true',
